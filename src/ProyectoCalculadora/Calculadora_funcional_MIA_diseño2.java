...
public class Calculadora_funcional_MIA_diseño2 extends JFrame {
    ...
    public Calculadora_funcional_MIA_diseño2(){
        ...
        pantalla_operaciones.setBackground(new Color(181,231,232));
        ...
        //ESTILO DE LA PANTALLA
        pantalla_resultado.setBackground(new Color(181,231,232));
        ...
        panel_abajo.setBackground(new Color(244,242,228));
    ...
    public static void main(String[] args) {
        Calculadora_funcional_MIA_diseño2 calculadora_funciona= new Calculadora_funcional_MIA_diseño2();
