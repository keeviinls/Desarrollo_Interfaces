...
public class Calculadora_funcional_MIA_diseño3 extends JFrame {
    ...
    public Calculadora_funcional_MIA_diseño3(){
        ...
        pantalla_operaciones.setBackground(new Color(246,247,251));
        ...
        //ESTILO DE LA PANTALLA
        pantalla_resultado.setBackground(new Color(246,247,251));
        ...
        panel_abajo.setBackground(new Color(75, 16, 31));
        ...
        for (String boton_string : botones){
            ...
            //BUCLE PARA CREAR LOS BOTONES Y NO HACERLOS DE 1 EN 1
                ...
                if (boton_string.equals("/") || boton_string.equals("CE") || boton_string.equals("√") ||
                    ...
                    boton.setBackground(new Color(145, 32, 70));
                ...
                // Configura el color de fondo de los botones 1, 2 y 3 a amarillo
                    ...
                    boton.setBackground(new Color(3,41,64));
                    boton.setForeground(Color.white);
    ...
    public static void main(String[] args) {
        Calculadora_funcional_MIA_diseño3 calculadora_funciona= new Calculadora_funcional_MIA_diseño3();
