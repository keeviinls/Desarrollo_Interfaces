...
public class EjercicioMyListWindows_SERGIO {
    public static void main(String[] args) {
        ...
        panelPrincipal.add(jlist, new GridBagConstraints(0, 0, 0, 1, 3, 4, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 35, 20, 35), 0, 0));
